<?php /** 
 * 
 *    N U O V A - V E R S I O N E 1.7
 * 
 *  */
class Xcrud_config
{
    // default connection
    /* public static $dbname = 'microhard'; // Your database name
    ...
    public static $dbname = 'db_microhard'; // Your database name
    public static $dbuser = 'user_microhard'; // Your database username
    public static $dbpass = '%7Hz5rM8?Y37a895O5%k'; // // Your database password
    public static $dbhost = '10.198.110.18'; // Your database host, 'localhost' is default.
    ...
    public static $session_error_message = "<h2>SESSIONE SCADUTA RIFAI IL LOGIN....</h2>"; 
    // multi session
    ...
    public static $upload_folder_def = '../immaginiprodotti'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
