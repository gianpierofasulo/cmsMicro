...
header("Access-Control-Allow-Headers: Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With");
        ...
        $endpoint_richiamato = "json_network.php";
       ...
       if ( $dati_log == 'OK') {
                    $update_table = $JsonFromMachine->carica_json_network('network',$JsonDATA, $id_utente, $id_macchina);
    ...
    //   echo json_encode( $decoded_json->network[0]->localIp_porta );
