...
header("Access-Control-Allow-Headers: Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With");
        ...
        $endpoint_richiamato = "json_contabilita_motori.php";
       ...
       if ( $dati_log == 'OK') {
                    $update_table = $JsonFromMachine->carica_json_contabilita_motori('contabilita_motori',$JsonDATA, $id_utente, $id_macchina);
