...
header("Access-Control-Allow-Headers: Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With");
        ...
        $endpoint_richiamato = "json_catalogoesercente.php";
        ...
        if ( $dati_log == 'OK') {
          $update_table = $JsonFromMachine->carica_json_catalogoesercente('catalogoesercente',$JsonDATA, $id_utente, $id_macchina);
    ...
    //   echo json_encode( $decoded_json[0]->codice_a_barre );
